...
CONTAINS
!
subroutine LTE_DRIVER(Nf, Nd, Na, qteShuffle, qteNorm, db, Nshuffles, r0, statP, frm)
  implicit none
...
!
  call WRITE_LTE(Natoms, Nframes, LocalTES, LocalTE, qTEShuffle)
!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine LSTE_DRIVER(Nf, Nd, Na, qteShuffle, qteNorm, db, Nshuffles, r0, statP, frm)
  implicit none
      integer, intent(in)        :: qTeNorm
      integer, intent(in)        :: qTeShuffle
      integer, intent(in)        :: Na, Nf
