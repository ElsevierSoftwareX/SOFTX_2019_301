...
!
      ...
      read(buffer,*, ERR=999) frm 
      write(*,*) "Chose the format of Input/Output data:           ", frm 
...
! 
      IF (qTEMethod == 1) THEN
          CALL STE1_DRIVER(Frm, Nframes, Ndim, Natoms,qteShuffle, qteNorm, debug, Nshuffles, Rcut, StatP)
      ELSEIF (qTEMethod == 2) THEN
          CALL STE2_DRIVER(Frm, Nframes, Ndim, Natoms,qteShuffle, qteNorm, debug, Nshuffles, Rcut, StatP)
      ELSEIF (qTEMethod == 3) THEN
          CALL STE3_DRIVER(Frm, Nframes, Ndim, Natoms,qteShuffle, qteNorm, debug, Nshuffles, Rcut, StatP)
      ELSE
          CALL TE_DRIVER(Frm, Nframes, Ndim, Natoms, qteShuffle, qteNorm, debug, Nshuffles, Rcut, StatP)      
      ENDIF
!
...
!
          ...
          write(*,*) "11 - Chose the format of Input/Output data                                                   - FRMT"
!					
          return
     end subroutine     	  
end program demo_te
