...
! 
      IF (qMIMethod == 1) THEN
          CALL SMI_DRIVER(frm, Nframes, Ndim, Natoms, qMIShuffle, debug, Nshuffles, Rcut, StatP)
      ELSE
          CALL  MI_DRIVER(frm, Nframes, Ndim, Natoms, qMIShuffle, debug, Nshuffles, Rcut, StatP)      
      ENDIF
!
...
contains
     subroutine help()
          ...
          write(*,*) "10 - Chose the format of Input/Output data                                  - FRMT"
!
          return
