...
!		  
      ...
      read(buffer,*, ERR=999) frmt 
      write(*,*) "Chose an output file format:                ", frmt
...
!	  
      ...
      IF (benchmark == 1) then
          CALL SETUP_DRIVER(frmt, Nframes, Ndim, Natoms, Offset, iStart, iSkip, iStop,     &
...
!     	  
            ...
            write(*,*) "9  - Chose an output file format  - Format"			
!					
          return
     end subroutine 
end program
