...
! 
      IF (qTEMethod == 1) THEN
          CALL LSTE_DRIVER(Nframes, Ndim, Natoms,qteShuffle, qteNorm, debug, Nshuffles, Rcut, StatP, frm)
      ELSE
          CALL LTE_DRIVER(Nframes, Ndim, Natoms, qteShuffle, qteNorm, debug, Nshuffles, Rcut, StatP, frm)      
      ENDIF
!
